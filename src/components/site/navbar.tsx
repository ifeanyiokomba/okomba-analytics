    ...
    <>
      <header
        className={cn(
          ...
          scrolled
            ? "border-b border-white/[0.07] bg-[#05070d]/85 backdrop-blur-xl"
        ...
        >
          ...
          <div className="flex items-center gap-3">
            <a
              ...
              className="hidden items-center gap-2 rounded-full border border-white/10 bg-white/[0.04] px-4 py-2 text-[13px] font-medium text-muted-foreground transition-colors hover:border-teal/40 hover:text-teal md:inline-flex focus-visible:outline-2 focus-visible:outline-teal"
            >
            ...
            <button
              ...
              aria-expanded={open}
              className="inline-flex h-11 w-11 items-center justify-center rounded-xl border border-white/10 bg-white/[0.04] text-foreground transition-colors hover:border-gold/40 lg:hidden focus-visible:outline-2 focus-visible:outline-gold"
            >
      ...
      <div
        className={cn(
          "fixed inset-0 z-40 bg-[#05070d]/97 backdrop-blur-2xl transition-all duration-300 lg:hidden",
