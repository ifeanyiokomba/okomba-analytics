...
// Icon mark — premium geometric O with golden diamond core
const OkombaLogo = ({ size = 38, className = "" }) => (
  <svg width={size} height={size} viewBox="0 0 100 100" fill="none"
    ...
    <defs>
      ...
      <linearGradient id="lgShine" x1="0%" y1="0%" x2="0%" y2="100%">
        <stop offset="0%" stopColor="#ffffff" stopOpacity="0.07"/>
        <stop offset="100%" stopColor="#ffffff" stopOpacity="0"/>
      </linearGradient>
      <filter id="fShadow" x="-20%" y="-20%" width="140%" height="140%">
        <feDropShadow dx="0" dy="2" stdDeviation="3" floodColor="#F0A500" floodOpacity="0.25"/>
      </filter>
    </defs>
    {/* Background tile */}
    <rect width="100" height="100" rx="24" fill="url(#lgBg)"/>
    <rect width="100" height="100" rx="24" fill="url(#lgShine)"/>
    <rect width="100" height="100" rx="24" fill="none" stroke="rgba(240,165,0,0.15)" strokeWidth="1"/>
    {/* Outer ring */}
    <circle cx="50" cy="50" r="34" fill="none" stroke="url(#lgGold)" strokeWidth="2.5" strokeDasharray="6 3" strokeLinecap="round"/>
    {/* Hexagon frame */}
    <polygon points="50,18 76,33 76,67 50,82 24,67 24,33"
      fill="rgba(240,165,0,0.06)" stroke="url(#lgGold)" strokeWidth="1.5"/>
    {/* Diamond core */}
    <polygon points="50,31 64,50 50,69 36,50"
      fill="url(#lgGold)" filter="url(#fShadow)"/>
    {/* Inner void */}
    <circle cx="50" cy="50" r="9" fill="#0B0F1A"/>
    {/* Center dot */}
    <circle cx="50" cy="50" r="3.5" fill="url(#lgGold)"/>
    {/* Corner accents */}
    <circle cx="50" cy="18" r="3" fill="#F0A500"/>
    <circle cx="50" cy="82" r="3" fill="#F0A500"/>
    <circle cx="76" cy="33" r="2" fill="#F0A500" fillOpacity="0.6"/>
    <circle cx="24" cy="33" r="2" fill="#F0A500" fillOpacity="0.6"/>
    <circle cx="76" cy="67" r="2" fill="#F0A500" fillOpacity="0.6"/>
    <circle cx="24" cy="67" r="2" fill="#F0A500" fillOpacity="0.6"/>
  </svg>
);
...
// Full horizontal lockup — icon + wordmark text
  ...
  <div style={{ display:"flex", alignItems:"center", gap:"10px" }}>
    ...
    <div style={{ display:"flex", flexDirection:"column", lineHeight:1.15 }}>
      <span style={{
        ...
        fontSize:`${height*0.48}px`, letterSpacing:"-0.02em", color:"#F2F4F8"
      }}>
        Okomba
      </span>
      <span style={{
        fontFamily:"'DM Mono',monospace", fontWeight:500,
        fontSize:`${height*0.23}px`, letterSpacing:"0.13em",
